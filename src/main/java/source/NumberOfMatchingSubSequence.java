...
public class NumberOfMatchingSubSequence {
    ...
    public int numMatchingSubseq(String S, String[] words) {
        ...
        for(int i=0; i<chs.length; i++){
            ...
            char ch = chs[i];
            if(m.containsKey(ch)){
                m.get((Character)ch).add(i);
            }

            else{
                ArrayList<Integer> a = new ArrayList<Integer>();
                a.add(i);
                m.put((Character)ch, a);
            }
        ...
        for(String w: words){
            ...
            while(i<ws.length){
                ...
                char ch = ws[i];
                if(!m.containsKey((Character)ch))
                {
                    break;
                }

                ArrayList<Integer> a = m.get((Character)ch);

                int j = binarySearch(a, 0, a.size(), idx);
                if(j==a.size()) break;

                idx = a.get(j) ;

                System.out.println("Looking for " + ch + " at index " + idx + " " + chs[idx]);
    ...
    public static void main(String[] args){
        ...
        NumberOfMatchingSubSequence testee = new NumberOfMatchingSubSequence();

        //System.out.println(testee.numMatchingSubseq("abcde",new String[]{"a","bb","acd","ace"}));

        System.out.println(testee.numMatchingSubseq("",
